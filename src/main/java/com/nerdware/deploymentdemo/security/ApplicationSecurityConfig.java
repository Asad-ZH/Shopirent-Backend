...
import com.nerdware.deploymentdemo.auth.ApplicationUserService;
import com.nerdware.deploymentdemo.jwt.JwtConfig;
import com.nerdware.deploymentdemo.jwt.JwtTokenVerifier;
import com.nerdware.deploymentdemo.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/**").hasRole(BUYER.name())
                .anyRequest()
                .authenticated();
    }
